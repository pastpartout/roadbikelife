...
class RoadbikelifeModelResizeimage
{
    ...
    public static function resizeImage(string|null $file, int|string|null $width = 0, int|string|null $height = 0, int $webP = 1, int $sharpenImage = 1, int $imageQuality = 95): string
    {
        if ($file) {
