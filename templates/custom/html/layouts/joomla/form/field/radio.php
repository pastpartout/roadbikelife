...
?>
<div data-toggle="buttons" id="<?php echo $id; ?>"
          class="<?php echo trim($class . ' w-100 btn-group-toggle ' . ($readonly || $disabled ? ' disabled' : '') . ($readonly ? ' readonly' : '')); ?>"
	...
	<?php if (!empty($options)) : ?>
		<?php foreach ($options as $i => $option) : ?>
			<?php
				...
				$option->class  = ($checked) ? 'btn btn-light active' : 'btn btn btn-light';
