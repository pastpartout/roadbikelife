							...
							>
								...
								<th scope="row" class="has-context">
									<div class="break-word">
                                        ...
                                        <? if(ComponentHelper::isEnabled('com_roadbikelife')):?>
                                        <div>
                                            <a class="btn btn-secondary mt-3 btn-sm" href="<?= JURI::base().'index.php?option=com_roadbikelife&view=createcontent&id='.$item->id?>">
                                                <span class="icon icon-edit icon-fw mr-2"></span>roadbikelife Content
                                            </a>
                                        </div>
                                        <? endif ?>
									</div>
